 ...
 * @author Nestor
 */
public class Ag_Ag_Basic_PSD_Evaluation extends AbstractPSDEvaluation {
    ...
    public Ag_Ag_Basic_PSD_Evaluation(Ag_Ag_KMC_config config, int repeats, int measureInterval) {
