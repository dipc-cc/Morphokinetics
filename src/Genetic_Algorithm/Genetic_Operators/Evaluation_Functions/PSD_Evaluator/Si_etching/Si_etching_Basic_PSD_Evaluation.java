 ...
 * @author Nestor
 */
public class Si_etching_Basic_PSD_Evaluation extends AbstractPSDEvaluation {
    ...
    public Si_etching_Basic_PSD_Evaluation(Si_etching_KMC_config config, int repeats, int measureInterval) {
