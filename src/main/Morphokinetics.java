 ...
 * etching, CVD growing and catalysis processes. To specify simulation mode "parameters" file must
 * be present in the current working directory (more details in {@link Parser}).
 *
