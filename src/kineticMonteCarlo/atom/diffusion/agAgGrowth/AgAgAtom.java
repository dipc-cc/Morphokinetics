...
public class AgAgAtom extends Abstract2DDiffusionAtom {
    ...
    private static AgAgTypesTable types_table;
    private final AgAgAtom[] neighbors = new AgAgAtom[6];
    private byte n_immobile;
    private byte n_mobile;

    public AgAgAtom(short X, short Y, HopsPerStep distance_per_step) {

        this.X = X;
        this.Y = Y;
        if (types_table == null) {
            types_table = new AgAgTypesTable();
        }
    ...
    public void setNeighbor(AgAgAtom a, int pos) {
        neighbors[pos] = a;
    }
    ...
    @Override
    public Abstract2DDiffusionAtom choose_random_hop() {
    ...
    public AgAgAtom ahead_corner_Atom(int corner_position) {
