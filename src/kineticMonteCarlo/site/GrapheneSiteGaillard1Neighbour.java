 ...
 */
public class GrapheneSiteGaillard1Neighbour extends GrapheneSite {
  
  public GrapheneSiteGaillard1Neighbour(int id, short iHexa, short jHexa, HopsPerStep distancePerStep) {
