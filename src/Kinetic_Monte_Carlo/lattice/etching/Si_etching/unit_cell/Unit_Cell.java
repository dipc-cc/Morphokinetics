...
public class Unit_Cell {
    ...
    protected Unit_Cell_Atom[][][] red0;
    protected Unit_Cell_Atom[][][] red1;
    protected Unit_Cell_Atom[][][] red2;
    protected Unit_Cell_Atom[][][] red3;
    protected int I_i, I_s, J_i, J_s, K_i, K_s;
    protected Unit_Cell_Atom[] Cells_Pointer;

    public double[][] getRotation() {
        return g;
    }

    public Unit_Cell_Atom[] getCellsP() {
...
//----------------------------------------------------
        ...
        this.I_s =  (int) Math.round(I_s) + 2;
        this.J_i =  (int) Math.round(J_i) - 2;
        this.J_s =  (int) Math.round(J_s) + 2;
        this.K_i =  (int) Math.round(K_i) - 2;
        this.K_s =  (int) Math.round(K_s) + 2;


        red0 = new Unit_Cell_Atom[this.I_s - this.I_i][this.J_s - this.J_i][this.K_s - this.K_i];
        red1 = new Unit_Cell_Atom[this.I_s - this.I_i][this.J_s - this.J_i][this.K_s - this.K_i];
        red2 = new Unit_Cell_Atom[this.I_s - this.I_i][this.J_s - this.J_i][this.K_s - this.K_i];
        red3 = new Unit_Cell_Atom[this.I_s - this.I_i][this.J_s - this.J_i][this.K_s - this.K_i];
        ...
        Cells_Pointer = new Unit_Cell_Atom[cuantos];
            ...
            for (int j = this.J_i; j < this.J_s; j++) { //Y SC B
                for (int k = this.K_i; k < this.K_s; k++) { //X SC B
                    ...
                    if (Xr >= 0 && Yr >= 0 && Zr >= 0 && Xr < limitX && Yr < limitY && Zr < limitZ) {
                        red0[i - this.I_i][j - this.J_i][k - this.K_i] = new Unit_Cell_Atom(Xr, Yr, Zr, 0);
        ...
        for (int i = this.I_i; i < this.I_s; i++) { //Eje Z
            for (int j = this.J_i; j < this.J_s; j++) { //Y SC B
                for (int k = this.K_i; k < this.K_s; k++) { //X SC B
                    ...
                    if (Xr >= 0 && Yr >= 0 && Zr >= 0 && Xr < limitX && Yr < limitY && Zr < limitZ) {
                        red1[i - this.I_i][j - this.J_i][k - this.K_i] = new Unit_Cell_Atom(Xr, Yr, Zr, 1);
        ...
        for (int i = this.I_i; i < this.I_s; i++) { //Eje Z
            for (int j = this.J_i; j < this.J_s; j++) { //Y SC B
                for (int k = this.K_i; k < this.K_s; k++) { //X SC B
                    ...
                    //if (i==1 && j==2 && k==4) {System.out.println(Xr);}
                    if (Xr >= 0 && Yr >= 0 && Zr >= 0 && Xr < limitX && Yr < limitY && Zr < limitZ) {
                        red2[i - this.I_i][j - this.J_i][k - this.K_i] = new Unit_Cell_Atom(Xr, Yr, Zr, 0);
        ...
        for (int i = this.I_i; i < this.I_s; i++) { //Eje Z
            for (int j = this.J_i; j < this.J_s; j++) { //Y SC B
                for (int k = this.K_i; k < this.K_s; k++) { //X SC B
                    ...
                    //if (i==1 && j==2 && k==4) {System.out.println(Xr);}
                    if (Xr >= 0 && Yr >= 0 && Zr >= 0 && Xr < limitX && Yr < limitY && Zr < limitZ) {
                        red3[i - this.I_i][j - this.J_i][k - this.K_i] = new Unit_Cell_Atom(Xr, Yr, Zr, 1);
