...
import Graphic_interfaces.Silicon_etching.mouseBehaviors.MouseZoom;
import Graphic_interfaces.Silicon_etching.mouseBehaviors.MouseTranslate;
import Graphic_interfaces.Silicon_etching.mouseBehaviors.MouseRotate;
import Graphic_interfaces.Silicon_etching.mouseBehaviors.MouseRocking;
 ...
 */
public class Silicon_frame extends javax.swing.JFrame implements KMC_graphics {

    private Silicon_PointArray sil;

    public Silicon_frame() {
        super();
    ...
    public void drawKMC(Abstract_KMC KMC) {
        ...
        if (sil == null) {
            sil = new Silicon_PointArray(new float[]{});
    ...
    private void create_Silicon_panel(float side) {
        ...
        Canvas3D_overlay canvas3D = new Canvas3D_overlay(config);
        add("Center", canvas3D);
