 ...
 */
public class AgRatesFromSsBruneAgAgPt implements IRates {
   ...
   *                               edge                 island       edge
   */
  public AgRatesFromSsBruneAgAgPt(double temperature) { 
    diffusionMl = 0.0035;
    P = 1e13;
    Pd = 1e13; //no lo sabemos
