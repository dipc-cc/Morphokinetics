...
public class Frame2D extends javax.swing.JFrame {
    ...
    public Frame2D showPSDControls(boolean enabled){
     ...
     public Frame2D setColorMap(int colormap){
       if (colormap==Panel2D.COLOR_HSV) jComboBox1.setSelectedIndex(0);
       if (colormap==Panel2D.COLOR_BW) jComboBox1.setSelectedIndex(1);
  ...
  private void initComponents() {
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
       if (jComboBox1.getSelectedIndex()==0) ((Panel2D)jPanel1).setColormap(Panel2D.COLOR_HSV);
       if (jComboBox1.getSelectedIndex()==1) ((Panel2D)jPanel1).setColormap(Panel2D.COLOR_BW);
