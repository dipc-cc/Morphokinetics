...
class Energy:
    ...
    def __init__(self):
        self.energies = 99999999*np.ones(18, dtype=float)
        self.energies[0] = 0     # P1
        self.energies[1] = 1.46  # P2
        self.energies[2] = 0     # P3
        self.energies[3] = 1.26  # P4
        self.energies[4] = 0.55  # P5
        self.energies[5] = 0.27  # P6
        self.energies[6] = 0     # P7
        self.energies[7] = 0     # P8
        self.energies[8] = 0.14  # P9
        self.energies[9] = 0.27  # P10
        self.energies[10] = 1.49 # P11
        self.energies[11] = 0.96 # P12
        self.energies[12] = 0.93 # P13
        self.energies[13] = 1.12 # P14
        self.energies[14] = 1.0  # P15
        self.energies[15] = 0    # P16
        self.energies[16] = 0.26 # P17
        self.energies[17] = 0.9  # P18
