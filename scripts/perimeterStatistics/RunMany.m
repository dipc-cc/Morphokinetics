function [Hist_angles,Hist_events,Hist_hops]=RunMany(IntRadius,filename)
  ...
  for iii=0:randomWalks:totalRandomWalks
    ...
    t=cputime;
    [DHist_angles,DHist_events,DHist_hops]=TestPerimeterStatisticsFast(events,randomWalks,IntRadius);    
